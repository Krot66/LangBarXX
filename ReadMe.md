...
Помимо флажков в виде картинок, возможно отображение разноцветных текстовых флажков сименами из названий раскладки, что описано [здесь](#10. Настройка флажков и визуальных элементов).
