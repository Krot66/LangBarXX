...
- Адаптирована к работе с множеством раскладок: исправление неверно     набранного текста не  ограничено парой языков     английский-русский, возможен быстрый выбор раскладок
...
Клавиши работы с множественными раскладками (Shift+1/F1…) должны работать на виртуальных машинах, и лучше пользоваться ими при множестве раскладок на гостевой системе. Как правило, на обоих типах виртуальных машин работает исправление раскладки и регистра с помощью флажка.
...
В каталоге  *masks* имеется также файл CapsLock.png, предназначенный для изменения цвета флажка, если он вас не устраивает. Он масштабируется до размера флажка при отображении, его размеры значения не имеют.
