...
- Ручное исправление раскладки набранного или выделенного текста. В отличие от Punto Switcher, происходит не мгновенное выделение последнего слова, а выделение набранных слов одно за другим слов с небольшой задержкой, так что и печатая не отрывая глаз от клавиатуры можно потом исправить все
...
Можно обменять функции клавиши *Pause* и сочетания *Shift+Backspace*, отметив соответствующий чекбокс, что сделано для ноутбуков, часто имеющих скрытую клавишу *Pause,* повешенную на сочетание с клавишей *Fn.* При этом сочетание *Shift+Backspace* будет работать с выделением вместо забоя (кроме требующих этого приложений), настройки же в выпадающем меню сохранятся. 

Следующий чекбокс позволяет предотвратить падения программ (например, VNote), связанные с посылкой сообщений PostMessage, как это делают все программы и скрипты данного класса. Программа отправляет обычные нажатия клавиш для переключения раскладки, что также исключает нарушение последовательности переключения языков при множестве раскладок.
...
> В ранних версиях Windows можно поменять лишь язык, стоящий на первом месте с помощью выпадающего меню вверху окна. В любом случае, следует ориентироваться только на последовательность языков в окне программы.
